...
const Page = () => {
    ...
    if (loading)
        return (
            <div className="min-h-screen bg-brand-base flex items-center justify-center text-brand-accent text-lg">
                Loading...
            </div>
        );
    if (error)
        return (
            <div className="min-h-screen bg-brand-base flex items-center justify-center text-red-400 text-lg">
                Error: {error}
            </div>
        );
    return (
